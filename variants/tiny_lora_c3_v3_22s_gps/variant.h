/*
 * TinyLora C3 V3 22S GPS - ESP32-C3 with GPS + E22-900M22S style module
 * (max 22dBm).
 * Difference from V3_22S: GPS on Serial1 (pins 20/21), GPS_EN on pin 2.
 * I2C is not used - pins 20/21 are repurposed for GPS Serial1.
 */
