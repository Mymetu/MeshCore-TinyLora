...
class TinyLora_C3_V2_22S_Board : public ESP32Board {
  uint32_t gpio_state = 0;

  static void heartbeatTask(void* param) {
    auto* board = (TinyLora_C3_V2_22S_Board*)param;
    while (true) {
...
public:
  ...
  const char *getManufacturerName() const override { return "TinyLora C3 V2 22S"; }
};
